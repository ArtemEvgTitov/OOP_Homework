...
class MultComplex():
    ...
    def result(self, x1, x2, y1, y2):
        new_real = Mult.MultRational.result(self, x1, x2) - Mult.MultRational.result(self, y1, y2)
        new_image = Mult.MultRational.result(self, y1, x2) + Mult.MultRational.result(self, x1, y2)
